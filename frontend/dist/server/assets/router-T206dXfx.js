...
const appCss = "/assets/styles-BjyW7TVY.css";
const DESCRIPTION$1 = "Multi-tenant Redis over HTTP. Isolated namespaces, per-project API keys, and a REST endpoint for every Redis operation. Free while in beta.";
...
const $$splitComponentImporter = () => import("./index-DJE9Cmwc.js");
const DESCRIPTION = "Multi-tenant Redis over HTTP. Isolated namespaces, per-project API keys, and a REST endpoint for every Redis operation. Free while in beta.";
